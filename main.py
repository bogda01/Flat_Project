...
while(ok==1):
    ...
    print("Type 5 to change the data from a certain ID.\n")
    print("Type 6 to get data with unknown results.\n")
    ...
    if(y=='1'):
        ...
        with open('C:/Andrei/Python/flat_project/data/breast-cancer-wisconsin.data','r') as f:
            contents=f.read()
            print("\nYour results: \n")
